...
public class WebSecurityConfig{
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
				...
				.antMatchers("/books/pending").hasAuthority("ADMIN")
				.antMatchers("/books/approved").hasAuthority("ADMIN")
				.antMatchers("/books/rejected").hasAuthority("ADMIN")
				.antMatchers("/books/upload").hasAuthority("USER")
